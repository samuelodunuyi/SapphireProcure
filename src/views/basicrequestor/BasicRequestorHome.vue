...
<template>
  ...
  <div v-if="showResults" class="overlay" @click="showResults = false">
    <div class="modal829 animated fadeInRight" @click.stop>
  ...
  <body>
    ...
    <div class="activityStatus">
      ...
      <div class="activityBoxGroup">
        ...
        <div class="activityBox" :style="{ cursor: 'pointer' }" @click="$router.push('/reviewVendor')">
          <Transition>
    ...
    <div class="Rfq">
      ...
      <div class="rfqtableHeader">
        ...
        <p class="tableHeadertext">Creation Date</p>
      ...
      <div class="paginationButtons" v-if="pageCount>1">
...
export default {
  ...
  async created() {
    ...
    this.userEmail = stores.signedInUserEmail
    let notifs = await notificationServices.getNotifications(this.userEmail)
  ...
  computed: {
    ...
    filteredRFQs() {
      ...
      if (!this.ascending) {
        this.contracts.reverse().slice(this.indexStart, this.indexEnd)
      }

      return this.contracts.slice(this.indexStart, this.indexEnd)
    },
  },
...
.rfqtableHeader {
  display: grid;
  grid-template-columns: 1.5fr 2.2fr 2fr 1fr;
  grid-gap: 20px;
  margin-left: 20px;
  width: 100%;
}
