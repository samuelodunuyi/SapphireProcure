...
<template>
  ...
  <div v-if="showResults" class="overlay" v-for="i in notifications" :key="i.id" @click="showResults = false">
    <div class="modal212 animated fadeInRight" @click.stop>
      ...
      <div class="Rfq">
        <div class="table-responsive-sm">
          <table class="table table-hover">
            ...
            <tbody>
              <tr v-for="value in filteredContracts" @click="navigateToRFQ(value.id)" :key="value.rfqNo"
                :style="{ cursor: 'pointer' }">
                <th scope="row">{{ value.id }}</th>
                <td>{{ value.description }}</td>
                <td>{{ value.expirationDateTime}}</td>
                <td v-if="value.bidSubmissionStatus === true">
                  <div class="div248" >
                  <img class="child61" alt="" src="../../assets/images/ellipse-85.svg" />
                  <p>Completed</p>
                </div>
                </td>
                <td v-if="value.bidSubmissionStatus === false">
                  <div class="div244" >
                  <img class="child61" alt="" src="../../assets/images/ellipse-84.svg" />
                  <p>Open</p>
                </div>
                </td>
              </tr>
...
export default {
  ...
  methods: {
    ...
    nextPage() {
      this.pageNumber++;
      this.pagevalue = this.pageNumber*10
    },
    prevPage() {
      this.pageNumber--;
      this.pagevalue = this.pageNumber*10
