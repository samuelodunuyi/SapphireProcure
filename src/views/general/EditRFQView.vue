...
<template>
            ...
            <div class="tableframe_" v-if="id == 1">
                ...
                <div class="justifcationSubHeader">
                    ...
                    <select name="rfqstatus" class="rfqstatus3_" v-model="selectedBidResponseLegal"
                        :disabled="disableJustificationLegal">
                ...
                <div class="justificationLine" v-if="selectedBidResponseLegal != ''">
                    ...
                    <textarea v-model="preferenceJustificationLegal" class="textarea23_" name="textarea" rows="17" cols="55"
                        :disabled="disableJustificationLegal"></textarea>
                    ...
                    <div class="justificationButton">
                        <button class="regularBtn" @click="showJustification = false"
                            :disabled="disableJustificationLegal">Cancel</button>
                        <button class="regularBtn" @click="selectasPreferredWinner()"
                            :disabled="disableJustificationLegal">Submit</button>
                    </div>
                </div>
            </div>
            ...
            <div class="tableframe_" v-if="id == 2">
                ...
                <div class="justifcationSubHeader">
                    ...
                    <select name="rfqstatus" class="rfqstatus3_" v-model="selectedBidResponseESG"
                        :disabled="disableJustificationESG">
                ...
                <div class="justificationLine" v-if="selectedBidResponseESG != ''">
                    ...
                    <textarea v-model="preferenceJustificationESG" class="textarea23_" name="textarea" rows="17" cols="55"
                        :disabled="disableJustificationESG"></textarea>
                    <p style="margin-left: 10px">Negotiated Bid Value(Optional)</p>
                    <CurrencyInput v-model="negotiatedBidValueESG" class="generalInput73_" :options="{ currency: 'NGN' }"
                        :disabled="disableJustificationESG" />
                    <div class="justificationButton">
                        <button class="regularBtn" @click="showJustification = false"
                            :disabled="disableJustificationESG">Cancel</button>
                        <button class="regularBtn" @click="selectasPreferredWinner()"
                            :disabled="disableJustificationESG">Submit</button>
                    </div>
                </div>
            ...
            <div class="tableframe_" v-if="id == 3">
                ...
                <div class="justifcationSubHeader">
                    ...
                    <select name="rfqstatus" class="rfqstatus3_" v-model="selectedBidResponseTechnical"
                        :disabled="disableJustificationTechnical">
                        <option :value=response.bidderId v-for="response in filteredbidderResponse">{{
                            response.bidderName }}
                        </option>
                    </select>
                ...
                <div class="justificationLine" v-if="selectedBidResponseTechnical != ''">
                    ...
                    <textarea v-model="preferenceJustificationTechnical" class="textarea23_" name="textarea" rows="17"
                        cols="55" :disabled="disableJustificationTechnical"></textarea>
                    <p style="margin-left: 10px">Negotiated Bid Value(Optional)</p>
                    <CurrencyInput v-model="negotiatedBidValueTechnical" class="generalInput73_"
                        :options="{ currency: 'NGN' }" :disabled="disableJustificationTechnical" />
                    <div class="justificationButton">
                        <button class="regularBtn" @click="showJustification = false"
                            :disabled="disableJustificationTechnical">Cancel</button>
                        <button class="regularBtn" @click="selectasPreferredWinner()"
                            :disabled="disableJustificationTechnical">Submit</button>
                    </div>
                </div>
    ...
    <div v-if="showContractToSendLegal" class="overlay_" @click="showContractToSendLegal = !showContractToSendLegal">
        <div class="modal6" @click.stop>
            <div class="main_1">
                ...
                }" v-model="contentLegal" :disabled="disableEditContractLegal" />
            </div>
            <div class="topBotton2_">
        ...
        <div class="modal6" @click.stop>
            <div class="main_1">
                <Editor api-key="a5xwo6r69r6w6av04foa9xikzbpf55uy3vog6pef3fw4fj25" :init="{
                    ...
                    editable_class: 'editable',
                    content_style: `.editable{background: #FBEEB8;}`
                }" v-model="contentESG" :disabled="disableEditContractESG" />
            </div>
            <div class="topBotton2_">
    ...
    <div v-if="deleteModal" class="overlay_" @click="deleteModal = false">
        <div class="modals2" @click.stop>
            <p style="font-size: 30; font-weight: 700;">Are you sure you want to Delete?</p>
            <div style="display: flex; flex-direction: row; gap: 20px;"> <button @click="deleteModal = false;"
                    class="topButton785_">
                    Cancel
                </button>
                <button @click="deleteRequisition(rfQNo)" class="topButton785_">
                    Delete
                </button>
            </div>
        </div>
        ...
        <div class="modal6" @click.stop>
            <div class="main_1">
                <Editor api-key="a5xwo6r69r6w6av04foa9xikzbpf55uy3vog6pef3fw4fj25" :init="{
                    ...
                    editable_class: 'editable',
                    content_style: `.editable{background: #FBEEB8;}`
                }" v-model="contentTechnical" :disabled="disableEditContractTechnical" />
            </div>
            <div class="topBotton2_">
                <!-- {{contentTechnical}} -->
    ...
    <div class="sandbox">
        ...
        <div class="topBotton_">
            ...
            <button class="topButton785_" @click="deleteModal = true" :disabled="disableDeleteBtn"> Delete</button>
            <button class="topButton785_" @click="completeRFQ()" :disabled="disableCompleteReqBtn"> Complete
                Requisition</button>
        </div>
                        ...
                        <div class="legal_">
                            <div class="legalTop_">
                                    ...
                                    <div class="ckeditor">
                                        ...
                                        <div class="document-editor__editable-container">
                                            <ckeditor :editor="editor" :config="editorConfig" @ready="onReady3"
                                                v-model="scopeofWorkLegal" :disabled="disableFieldLegal"
                                                class="checkEditor"></ckeditor>
                                        </div>
                                    </div>
                                </div>
                                <div class="category785_">
                                    ...
                                    <div class="frame12349_">
                                        ...
                                        <select name="rfqstatus" class="rfqstatus_" v-model="selectedRFQSubTypeLineLegal"
                                            :disabled="disableFieldLegal" v-if="selectedRFQTypeLineLegal == 'TAF'">
                                ...
                                <div class="topBotton_2">
                                    ...
                                    <button class="topButton785_" @click="getBiddersbyServiceCategoryLineIdLegal()"
                                        :disabled="disablePreferredBidderBtnLegal">Nominate Select Bidders</button>
                                    <button class="topButton785_" @click="notifyBiddersLegal()"
                                        :disabled="disableSendRFQLegalBtn">Send RFQ to Bidders</button>
                                </div>
                            </div>
                            ...
                            <div class="topBotton_">
                                <button class="topButton785_" @click="resetLineBiddersLegal()"
                                    :disabled="disableResetBtnLegal">Reset Bidders</button>
                                <button :disabled="!showBidSubmitandValueLegal" class="topButton785_"
                                    @click="reviewQuotes(1)">Review Quotes</button>
                                <button class="topButton785_" @click="showContractToSendLegal = true"
                                    :disabled="WinnerbidderIdLegal.length < 4">
                                    Edit/Send Contract</button>
                                <button class="topButtonU_" :disabled="!showBidSubmitandValueLegal"
                        ...
                        <div class="legal_">
                            <div class="legalTop_">
                                    ...
                                    <div class="ckeditor">
                                        ...
                                        <div class="document-editor__editable-container">
                                            <ckeditor :editor="editor" :config="editorConfig" @ready="onReady4"
                                                v-model="scopeofWorkESG" :disabled="disableFieldESG" class="checkEditor">
                                            </ckeditor>
                                        </div>
                                    </div>
                                </div>
                                <div class="category785_">
                                    ...
                                    <div class="frame12348_">
                                        <input name="rfqno" type="number" placeholder="Input Days/Hours"
                                            v-model="selectTimeESG" :disabled="disableFieldESG">
                                    ...
                                    <div class="frame12349_">
                                        ...
                                        <select name="rfqstatus" class="rfqstatus_" v-model="selectedRFQSubTypeLineESG"
                                            :disabled="disableFieldESG" v-if="selectedRFQTypeLineESG == 'TAF'">
                                            <option value="">Select Subtype</option>
                                            <option :value=rfqSubTp.id v-for="rfqSubTp in rfqSubType">{{
                                                rfqSubTp.description }}</option>
                                        </select>
                                ...
                                <div class="topBotton_2">
                                    ...
                                    <button class="topButton785_" @click="getBiddersbyServiceCategoryLineIdESG()"
                                        :disabled="disablePreferredBidderBtnESG">Nominate Select Bidders</button>
                                    <button class="topButton785_" @click="notifyBiddersESG()"
                                        :disabled="disableSendRFQESGBtn">Send
                            ...
                            <div class="topBotton_">
                                <button class="topButton785_" @click="resetLineBiddersESG"
                                    :disabled="disableResetBtnESG">Reset
                                    Bidders</button>
                                ...
                                <button class="topButton785_" @click="showContractToSendESG = true"
                                    :disabled="WinnerbidderIdESG.length < 4">
                                    Edit/Send Contract</button>
                                <button class="topButtonU_" :disabled="!showBidSubmitandValueESG"
                                    @click="notifyLosers()">Notify Unsuccessful
                                    Bidders</button>
                        ...
                        <div class="legal_">
                            <div class="legalTop_">
                                    ...
                                    <div class="ckeditor">
                                        ...
                                        <div class="document-editor__editable-container">
                                            <ckeditor :editor="editor" :config="editorConfig" @ready="onReady5"
                                                v-model="scopeofWorkTechnical" :disabled="disableFieldTechnical"
                                                class="checkEditor"></ckeditor>
                                        </div>
                                    </div>
                                </div>
                                <div class="category785_">
                                    ...
                                    <select name="rfqstatus" class="rfqstatus3_"
                                        v-model="selectedServiceCategoryLineTechnical" :disabled="disableFieldTechnical">
                                        <option :value=serviceCategory.id
                                    ...
                                    <div class="frame12349_">
                                        ...
                                        <select name="rfqstatus" class="rfqstatus_"
                                            v-model="selectedRFQSubTypeLineTechnical" :disabled="disableFieldTechnical"
                                ...
                                <div class="topBotton_2">
                                    ...
                                    <button class="topButton785_" @click="getBiddersbyServiceCategoryLineIdTechnical()"
                                        :disabled="disablePreferredBidderBtnTechnical">Nominate Select Bidders</button>
                                    <button class="topButton785_" @click="notifyBiddersTechnical()"
                                        :disabled="disableSendRFQTechnicalBtn">Send RFQ to Bidders</button>
                                </div>
                            </div>
                            ...
                            <div class="topBotton_">
                                <button class="topButton785_" @click="resetLineBiddersTechnical"
                                    :disabled="disableResetBtnTechnical">Reset Bidders</button>
                                ...
                                <button class="topButton785_" @click="showContractToSendTechnical = true"
                                    :disabled="WinnerbidderIdTechnical.length < 4">
                                    Edit/Send Contract</button>
                                <button class="topButtonU_" :disabled="!showBidSubmitandValueTechnical"
                                    @click="notifyLosers()">Notify Unsuccessful
                                    Bidders</button>
...
export default {
    ...
    async created() {
        ...
        this.biddersTotalList = await biddersService.getBidders()
    ...
    methods: {
        ...
        async deleteRequisition() {
            await requisitionsServices.deleteRfq(this.rfQNo);
        ...
        async getBiddersbyServiceCategoryLineIdLegal() {
            ...
            this.preferredBidders = await biddersService.getBiddersWithPerformanceScoresbyServiceCategoryLineId(this.selectedServiceCategoryLineLegal)
        ...
        async getBiddersbyServiceCategoryLineIdTechnical() {
            ...
            this.preferredBidders = await biddersService.getBiddersWithPerformanceScoresbyServiceCategoryLineId(this.selectedServiceCategoryLineTechnical)
            this.showPreferredBidders = !this.showPreferredBidders
        },
        ...
        async getBiddersbyServiceCategoryLineIdESG() {
            ...
            this.preferredBidders = await biddersService.getBiddersWithPerformanceScoresbyServiceCategoryLineId(this.selectedServiceCategoryLineESG)
            this.showPreferredBidders = !this.showPreferredBidders
        },
        ...
        async notifyBiddersLegal() {
            ...
            for (let i = 0; i < bidderEmailfromSelectedbidders.length; i++) {
                let bidderAltEmails = this.biddersTotalList.filter(o => o.primaryEmailAddress == bidderEmailfromSelectedbidders[i])
                let bidderAltEmail1fromSelectedbidders = bidderAltEmails[0].alternativeEmail1
                let bidderAltEmail2fromSelectedbidders = bidderAltEmails[0].alternativeEmail2
                let bidderAltEmail3fromSelectedbidders = bidderAltEmails[0].alternativeEmail3


                if (bidderAltEmail1fromSelectedbidders == null) {
                    bidderAltEmail1fromSelectedbidders = "info23@gmail.com"
                }
                if (bidderAltEmail2fromSelectedbidders == null) {
                    bidderAltEmail2fromSelectedbidders = "info23@gmail.com"
                }
                if (bidderAltEmail3fromSelectedbidders == null) {
                    bidderAltEmail3fromSelectedbidders = "info23@gmail.com"
                }
                await emailService.sendBidInvite(bidderEmailfromSelectedbidders[i], bidderNamefromSelectedbidders[i], `Invite to ${this.rfQNo} Bid`, this.rfQNo, bidderNamefromSelectedbidders[i], '', new Date().toJSON(), '', 'procurement@infracredit.ng', 'Procurement Team', bidderAltEmail1fromSelectedbidders, bidderAltEmail2fromSelectedbidders, bidderAltEmail3fromSelectedbidders)
            }
            if (sendnom) {
        ...
        async notifyBiddersESG() {
            ...
            let bidderAltEmail1fromSelectedbidders = biddersServiceLineMapName.map(function (item) {
                return item.bidderAlternativeEmail1;
            });
            let bidderAltEmail2fromSelectedbidders = biddersServiceLineMapName.map(function (item) {
                return item.bidderAlternativeEmail2;
            });
            let bidderAltEmail3fromSelectedbidders = biddersServiceLineMapName.map(function (item) {
                return item.bidderAlternativeEmail3;
            });
            let sendnom = await requisitionsServices.sendRFQToNominatedBidders(this.rfQNo, 3, this.requestoremail)


            for (let i = 0; i < bidderEmailfromSelectedbidders.length; i++) {
                if (bidderAltEmail1fromSelectedbidders[i] == null) {
                    bidderAltEmail1fromSelectedbidders[i] = "info23@gmail.com"
                }
                if (bidderAltEmail2fromSelectedbidders[i] == null) {
                    bidderAltEmail2fromSelectedbidders[i] = "info23@gmail.com"
                }
                if (bidderAltEmail3fromSelectedbidders[i] == null) {
                    bidderAltEmail3fromSelectedbidders[i] = "info23@gmail.com"
                }
                await emailService.sendBidInvite(bidderEmailfromSelectedbidders[i], bidderNamefromSelectedbidders[i], `Invite to ${this.rfQNo} Bid`, this.rfQNo, bidderNamefromSelectedbidders[i], '', new Date().toJSON(), '', 'procurement@infracredit.ng', 'Procurement Team', bidderAltEmail1fromSelectedbidders[i], bidderAltEmail2fromSelectedbidders[i], bidderAltEmail3fromSelectedbidders[i])
            }
            if (sendnom) {
