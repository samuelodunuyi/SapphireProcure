          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr v-for="contract in filteredContracts" :key="contract.id"
                @click="showRatings(contract.id, contract.bidderName)" :style="{ cursor: 'pointer' }">
  ...
  methods: {
    ...
    async showRatings(idx, name) {
      ...
      if (this.bidderPerformanceRatingByContract.length > 0) {
        ...
        console.log(this.ratingTotalDisplay)

      }
    },

    createPerformanceRatings() {
      ratingServices.createBidderPerformances(this.BidContactNo, this.BidderId, this.RFQRequestedUserId, 5, this.ratingTime)
      ratingServices.createBidderPerformances(this.BidContactNo, this.BidderId, this.RFQRequestedUserId, 6, this.ratingQuality)
      ratingServices.createBidderPerformances(this.BidContactNo, this.BidderId, this.RFQRequestedUserId, 7, this.ratingResponsive)
      ratingServices.createBidderPerformances(this.BidContactNo, this.BidderId, this.RFQRequestedUserId, 8, this.ratingReliability)
      ratingServices.createBidderPerformances(this.BidContactNo, this.BidderId, this.RFQRequestedUserId, 9, this.ratingProffessionality)
